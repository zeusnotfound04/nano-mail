...
export namespace Prisma {
  ...
  */
  ...
  export type emailsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "sender" | "recipients" | "subject" | "body" | "size" | "created_at", ExtArgs["result"]["emails"]>
  ...
  interface emailsFieldRefs {
    ...
    readonly sender: FieldRef<"emails", 'String'>
    readonly recipients: FieldRef<"emails", 'String[]'>
    readonly subject: FieldRef<"emails", 'String'>
    readonly body: FieldRef<"emails", 'String'>
    readonly size: FieldRef<"emails", 'BigInt'>
  ...
  export type emailsWhereInput = {
    ...
    sender?: StringNullableFilter<"emails"> | string | null
    recipients?: StringNullableListFilter<"emails">
    subject?: StringNullableFilter<"emails"> | string | null
    body?: StringNullableFilter<"emails"> | string | null
    size?: BigIntNullableFilter<"emails"> | bigint | number | null
  ...
  export type emailsScalarWhereWithAggregatesInput = {
    ...
    sender?: StringNullableWithAggregatesFilter<"emails"> | string | null
    recipients?: StringNullableListFilter<"emails">
    subject?: StringNullableWithAggregatesFilter<"emails"> | string | null
    body?: StringNullableWithAggregatesFilter<"emails"> | string | null
    size?: BigIntNullableWithAggregatesFilter<"emails"> | bigint | number | null
    created_at?: DateTimeNullableWithAggregatesFilter<"emails"> | Date | string | null
  }

  export type emailsCreateInput = {
    sender?: string | null
    recipients?: emailsCreaterecipientsInput | string[]
    subject?: string | null
    body?: string | null
  ...
  export type emailsUpdateInput = {
    ...
    recipients?: emailsUpdaterecipientsInput | string[]
  ...
  export type emailsCreaterecipientsInput = {
    set: string[]
  }
  ...
  export type emailsUpdaterecipientsInput = {
    set?: string[]
    push?: string | string[]
  }
